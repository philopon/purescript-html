...
var PS = PS || {};
PS.Data_Html_Internal_Stringify = (function () {
    "use strict";
    var Prelude = PS.Prelude;
...
var PS = PS || {};
PS.Data_Html_Stringify = (function () {
    "use strict";
    var Data_Function = PS.Data_Function;
    var Data_Html_Internal_Stringify = PS.Data_Html_Internal_Stringify;
    var Prelude = PS.Prelude;
    
function stringifyVNodeImpl(stringify, opts, vnode){
  return stringify(vnode);
};
    var stringifyVNode = Data_Function.runFn3(stringifyVNodeImpl)(Data_Html_Internal_Stringify.stringify);
    var showVTree = new Prelude.Show(stringifyVNode({}));
    return {
        showVTree: showVTree, 
        stringifyVNode: stringifyVNode
    };
})();
var PS = PS || {};
...
function eq2Func(f){
  return function eq2Func_apply(a,b){
    ...
    var partial2 = function (eq) {
        return function (f) {
            return Data_Function.runFn3(Data_Html_Internal_VirtualDOM.virtualDOM.partial(eq2Func(eq)))(Data_Function.mkFn2(f));
        };
    };
    var partial1 = function (eq) {
        return Data_Function.runFn2(Data_Html_Internal_VirtualDOM.virtualDOM.partial(eq1Func(eq)));
    };
    return {
        partial1: partial1, 
        partial2: partial2
...
PS.Main = (function () {
    ...
    var Data_Html_Events_Heavy = PS.Data_Html_Events_Heavy;
    ...
    var Control_Monad_Eff = PS.Control_Monad_Eff;
    var Data_Html_Stringify = PS.Data_Html_Stringify;
  ...
  function appendSelector(sel, node) {
    ...
    var test2 = Data_Html_Elements_Html5.div([ Data_Html_Events_Heavy.onMouseMove(Debug_Trace.print(Data_Html_Events.showMouseHoverEvent)) ])([ Data_Html_Elements_Html5.text("inu"), Data_Html_Elements_Html5.span([ Data_Html_Attributes_Html5.style({
        color: "red"
    }) ])([ Data_Html_Elements_Html5.text("bowow") ]), Data_Html_Elements_Html5.input([  ])([  ]) ]);
    var test1 = function (color) {
        return Data_Html_Elements_Html5.div([ Data_Html_Attributes_Html5.class_("neko"), Data_Html_Attributes_Html5.title("title"), Data_Html_Attributes_Html5.id_("idnt"), Data_Html_Attributes_Html5.style({
            color: color
        }) ])([ Data_Html_Elements_Html5.text("neko") ]);
    };
    var main = function __do() {
        Data_Html_Events_Heavy.listenMouseMove();
        Debug_Trace.print(Data_Html_Stringify.showVTree)(test1("black"))();
        var _8 = Data_Html.createElement(Data_Html_Lazy.partial1(Prelude["=="](Prelude.eqString))(test1)("blue"))();
        Prelude[">>="](Control_Monad_Eff.bindEff)(Data_Html.getNode(_8))(Data_Function.runFn2(appendSelector)("div"))();
        Control_Timer.timeout(100)(function __do() {
            Data_Html.patch(Data_Html_Lazy.partial2(function (a) {
                return function (b) {
                    return a.a === b.b;
                };
            })(function (a) {
            ...
            return Control_Timer.timeout(1000)(Data_Html.patch(test2)(_8))();
        })();
        return Prelude.unit;
    };
    return {
