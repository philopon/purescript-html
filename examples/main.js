...
var PS = PS || {};
PS.Html_VirtualDOM_Stringify = (function () {
    "use strict";
...
var PS = PS || {};
PS.Html_Stringify = (function () {
    "use strict";
    var Data_Function = PS.Data_Function;
    var Html_VirtualDOM_Stringify = PS.Html_VirtualDOM_Stringify;
    var Prelude = PS.Prelude;
    
function stringifyVNodeImpl(stringify, opts, vnode){
  return stringify(vnode);
};
    var stringifyVNode = Data_Function.runFn3(stringifyVNodeImpl)(Html_VirtualDOM_Stringify.stringify);
...
PS.Main = (function () {
    ...
    var Control_Monad_Eff = PS.Control_Monad_Eff;
    var Html_Stringify = PS.Html_Stringify;
  ...
  function appendSelector(sel, node) {
    ...
    var main = function __do() {
        ...
        Debug_Trace.print(Html_Stringify.showVTree)(test1("black"))();
